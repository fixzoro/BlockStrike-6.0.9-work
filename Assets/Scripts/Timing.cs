...
public static class MECExtensionMethods2
{
    ...
    {
        while (MovementEffects.Timing.MainThread != System.Threading.Thread.CurrentThread ||
    ...
    public static IEnumerator<float> CancelWith(this IEnumerator<float> coroutine, System.Func<bool> condition)
    {
        ...
        while (MovementEffects.Timing.MainThread != System.Threading.Thread.CurrentThread || (condition() && coroutine.MoveNext()))
            yield return coroutine.Current;
    }
    ...
    {
        while (MovementEffects.Timing.MainThread == System.Threading.Thread.CurrentThread && gameObject)
        {
            ...
            {
                yield return MovementEffects.Timing.WaitForOneFrame;
            }
        }
    }
    ...
    {
        while (MovementEffects.Timing.MainThread == System.Threading.Thread.CurrentThread && gameObject1 && gameObject2)
        {
    ...
    public static IEnumerator<float> PauseWith<T>(this IEnumerator<float> coroutine, T script) where T : MonoBehaviour
    {
        ...
        while (MovementEffects.Timing.MainThread == System.Threading.Thread.CurrentThread && myGO && myGO.GetComponent<T>() != null)
        {
    ...
    /// <returns>The modified coroutine handle.</returns>
    public static IEnumerator<float> KillWith(this IEnumerator<float> coroutine, MovementEffects.CoroutineHandle otherCoroutine)
    {
