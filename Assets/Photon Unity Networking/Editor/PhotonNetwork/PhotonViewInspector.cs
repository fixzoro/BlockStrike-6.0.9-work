...
//        if (this.m_Target.punObservables == null)
//        {
//            this.m_Target.punObservables = new IPunObservable[0];
//        }

//        if (this.m_Target.punObservables.Length == 0)
//        {
//            this.m_Target.AddPunObservable(null);
//        }
...
//        if (this.m_Target.synchronization != ViewSynchronization.Off && this.m_Target.punObservables.Length == 0)
//        {
...
//        for (int i = 0; i < this.m_Target.punObservables.Length; ++i)
//        {
//            if (this.m_Target.punObservables[i] != null)
//            {
//                count++;
//            }
//        }
...
//    {
//        GUILayout.Space(5);
//        SerializedProperty listProperty = serializedObject.FindProperty("punObservables");
...
//        bool wasObservedComponentsEmpty = this.m_Target.punObservables.Length == 0;
//        if (isOpen == true)
//        {
...
//        bool isObservedComponentsEmpty = this.m_Target.punObservables.Length == 0;
