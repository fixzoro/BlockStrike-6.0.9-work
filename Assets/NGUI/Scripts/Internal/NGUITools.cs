...
static public class NGUITools
{
    ...
    static public void ExecuteAll<T>(GameObject root, string funcName, bool updataChild) where T : Component
    {
        ...
        if (updataChild)
        {
            ...
            for (int i = 0, imax = t.childCount; i < imax; ++i)
                ExecuteAll<T>(t.GetChild(i).gameObject, funcName, updataChild);
        }
    }
    ...
    static public void ImmediatelyCreateDrawCalls(GameObject root, bool updataChild = true)
    {
        ExecuteAll<UIWidget>(root, "Start", updataChild);
        ExecuteAll<UIPanel>(root, "Start", updataChild);
        ExecuteAll<UIWidget>(root, "Update", updataChild);
        ExecuteAll<UIPanel>(root, "Update", updataChild);
        ExecuteAll<UIPanel>(root, "LateUpdate", updataChild);
    }
#endif
