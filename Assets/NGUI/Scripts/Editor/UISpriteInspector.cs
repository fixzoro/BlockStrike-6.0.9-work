...
public class UISpriteInspector : UIBasicSpriteEditor
{
	...
	protected override bool ShouldDrawProperties ()
	{
        ...
        SerializedProperty gs = serializedObject.FindProperty("isGray");
        SerializedProperty bs = serializedObject.FindProperty("isBright");
        NGUIEditorTools.DrawProperty("IsGrayScale", gs);
        NGUIEditorTools.DrawProperty("IsBrightScale", bs);
        return true;
	}
