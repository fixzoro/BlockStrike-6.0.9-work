Shader "MADFINGER/Environment/Scroll 2 Layers Multiplicative - additive blend" {
Properties {
...
MUL result.texcoord[2].xyz, vertex.color, c[12].x;
DP4 result.position.w, vertex.position, c[4];
DP4 result.position.z, vertex.position, c[3];
DP4 result.position.y, vertex.position, c[2];
DP4 result.position.x, vertex.position, c[1];
MOV result.texcoord[2].w, vertex.color;
END
...
"vs_4_0
eefieceddhkaejjiefgddhkippekdchhlchcbmiiabaaaaaaleadaaaaadaaaaaa
...
daacaaaaeaaaabaaimaaaaaafjaaaaaeegiocaaaaaaaaaaaafaaaaaafjaaaaae
...
aaaaaaahmccabaaaabaaaaaakgaobaaaabaaaaaaagaebaaaaaaaaaaadiaaaaai
hccabaaaacaaaaaaegbcbaaaafaaaaaaagiacaaaaaaaaaaaaeaaaaaadgaaaaaf
iccabaaaacaaaaaadkbabaaaafaaaaaadoaaaaab"
}
SubProgram "d3d11_9x " {
Keywords { "LIGHTMAP_OFF" }
Bind "vertex" Vertex
...
BindCB  "UnityPerDraw" 2
"vs_4_0_level_9_3
eefiecedhiofnncmgpkdeinkaaljjmalomoongmgabaaaaaadaafaaaaaeaaaaaa
daaaaaaakiabaaaaoaadaaaakiaeaaaaebgpgodjhaabaaaahaabaaaaaaacpopp
...

...
aaaappiaaaaaoekaaaaaoeiaabaaaaacaaaaammaaaaaoeiaabaaaaacabaaaioa
afaappjappppaaaafdeieefcdaacaaaaeaaaabaaimaaaaaafjaaaaaeegiocaaa
...
ogikcaaaaaaaaaaaabaaaaaadiaaaaajpcaabaaaabaaaaaaegiocaaaaaaaaaaa
...

...
heaaaaaaacaaaaaaaaaaaaaaadaaaaaaacaaaaaaapaaaaaafdfgfpfaepfdejfe
